...
namespace ServiceUitls.Database
{
    ...
    public abstract class DbHelperOdbc
    {
        ...
        public static string connectionString = "Dsn=market;Uid=adm0;Pwd=systemcom";
        public static string OEM_SQL = "SET TEMPORARY OPTION CONNECTION_AUTHENTICATION='Company=MoleQ Inc.;Application=MoleQ Solutions;Signature=000fa55157edb8e14d818eb4fe3db41447146f1571g2a2ac0b2993b8eebd8393550f631933e5451b12b'";
        ...
        public static void MoleQOEMSetOption()
        {
            try
            {
                DbHelperOdbc.ExecuteSql("SET TEMPORARY OPTION CONNECTION_AUTHENTICATION='Company=MoleQ Inc.;Application=MoleQ Solutions;Signature=000fa55157edb8e14d818eb4fe3db41447146f1571g2a2ac0b2993b8eebd8393550f631933e5451b12b'");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static void SetOEMOption(OdbcConnection connection)
        {
        ...
        public static int RunProcedure(string storedProcName)
        {
            using (OdbcConnection connection = new OdbcConnection(connectionString))
            {
                ...
                using (var cmd = new OdbcCommand(DbHelperOdbc.OEM_SQL, connection))
                {
                    cmd.ExecuteNonQuery();
                }
